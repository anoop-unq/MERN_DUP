...
const Login = () => {
  const { backendUrl, setIsLogged, getUserData,guest,postGuest,getGuest,realGuest } = useContext(AppContext);
  ...
  const handleGuest = async()=>{
    ...
    if(guest.data.existingGuest){
      console.log(guest.data.existingGuest)
      toast.success(guest.data.message)
      await getGuest()
      navigate("/home")
    }
    else{
    ...
    // await getGuest()
    // console.log(realGuest)
    // if(realGuest.success){
    //   navigate("/home")
  ...
  >
    <FaArrowLeft className="mr-2 text-2xl" />
        ...
        <form className="space-y-6">
          ...
          <div className="flex items-center justify-between p-2" onClick={handleGuest}>
           <div className="flex items-center">
          <IoMdContact className="font-bold size-5 mr-1.5" />
          <p className="font-light size-6">Guest</p>
          </div>
...
// const Login = () => {
//   const { backendUrl, setIsLogged, getUserData,createGuestProfile } = useContext(AppContext);
//   const [data, setData] = useState({ name: "", email: "", password: "" });
//   const navigate = useNavigate();
//   const location = useLocation();
//   const [formType, setFormType] = useState("login");
...
//     // If you want to simulate a guest login without backend
//     // setIsLogged(true);
//     await createGuestProfile()
//     console.log("hii")
//     // Optionally, handle guest-specific data if needed
...
//             <div className="flex items-center" onClick={handleGuestLogin}>
//               <IoMdContact className="font-bold size-5 mr-1.5" />
//               <p className="font-light size-6">Guest</p>
//             </div>
